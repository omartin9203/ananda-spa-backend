...
import { BaseFormDto } from '../base/base-form.dto';
import { ParentConsentType } from '../parent-consent/parent-consent.dto';

@ObjectType('MassageFormType')
export class  MassageFormDto extends BaseFormDto {
  @Field({ nullable: true })
  occupation?: string;
  @Field({ nullable: true })
